...
> **Latest measurement:** **2026-06-01 against `@openwop/openwop-conformance@1.15.0` — 1992 passed / 46 failed / 105 skipped / 0 todo of 2143 tests (92.9%)**. See `INTEROP-MATRIX.md` for the cross-host comparison. Failures are honest non-claims for surfaces the minimal host does not behaviorally implement (artifacts, bulk-cancel, BYOK, cap/cost-breach, channel-TTL, interrupts, multi-agent dispatch, et al.); failures fell 48 → 46 even as the suite grew 2074 → 2143 (the v1.11–v1.15 scenarios), and `it.todo` is 0.
>
