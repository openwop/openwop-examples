...
> **Latest measurement (2026-05-22, suite v1.4.0):** **1467 passed / 6 failed / 69 skipped / 16 todo of 1558 tests (94.2% total; 99.6% of non-skipped)** against `@openwop/openwop-conformance@1.4.0` running with pglite + `OPENWOP_WEBHOOK_ALLOW_PRIVATE=true`. See `docs/CONFORMANCE-RUNS-2026-05.md` for the per-failure-topic taxonomy. The 6 failures concentrate in two named close-out tracks: RFC 0026 cost-attribution `conformance.cost.emit` fixture-node wiring (2 failures) and RFC 0022 dispatch input/output mapping supervisor-mock extension (4 failures). Neither is a wire-shape change; neither blocks any v1 production-profile MUST.
>
> **Prior snapshot:** 2026-05-13 against suite v1.1.0 — 781/850 (91.9% total; 96.4% of applicable). Retained below for historical context; not directly comparable since the suite scenario count grew from 850 to 1558.
